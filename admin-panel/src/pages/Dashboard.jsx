...
import { Users, Film, Wrench, ArrowUpRight, Clock, CheckCircle } from 'lucide-react'
...
export default function Dashboard() {
  ...
  async function fetchDashboardData() {
    try {
      ...
      // 2. Buscar atividades recentes (leads, conteúdo e suporte)
      ...
      setRecentActivities(activities.slice(0, 5)) // pegar as 5 mais recentes
  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '30px' }}>
        ...
        {/* Taxa de Conversão */}
        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '40px 20px', textAlign: 'center' }}>
          ...
          <div style={{ position: 'relative', display: 'inline-flex', justifyContent: 'center', alignItems: 'center', margin: '20px 0' }}>
            {/* Círculo de progresso simulado estilizado */}
            <div style={{ 
              width: '150px', 
              height: '150px', 
              borderRadius: '50%', 
              ...
              <div style={{ 
                ...
                <span style={{ fontSize: '2rem', fontWeight: '800', fontFamily: 'Outfit' }}>{loading ? '...' : `${conversionRate}%`}</span>
                <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: '700', letterSpacing: '0.5px' }}>de Sucesso</span>
              </div>
            </div>
          </div>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', maxWidth: '280px', margin: '10px 0 0 0' }}>
            De <b>{stats.leads} leads</b> capturados pelo formulário, <b>{stats.converted}</b> foram fechados como assinatura.
          </p>
        </div>
              ...
              recentActivities.map((act) => (
                <div key={act.id} style={{ 
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>{act.detail}</span>
                  </div>
